        ...
        <div className="flex flex-col items-center mt-4">
            ...
            <div className="inline-flex mt-2">
                <button
                    ...
                    className={`flex items-center justify-center h-8 px-3 text-sm font-medium text-white bg-gray-700 rounded-l ${page === 1 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-900'}`}
                    disabled={page === 1}
                >
                ...
                <button
                    ...
                    className={`flex items-center justify-center h-8 px-3 text-sm font-medium text-white bg-gray-700 border-l border-gray-700 rounded-r ${page === totalPages ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-900'}`}
