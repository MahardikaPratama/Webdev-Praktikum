...
describe('Fitur Home', () => {
    ...
    // Pengujian untuk kasus parameter tidak lengkap (misalnya tidak ada tahun, genre, atau halaman)
    describe('filterSortMovies dengan parameter tidak lengkap', () => {
    ...
    // Pengujian untuk parameter pagination yang tidak valid (misalnya limit yang lebih besar dari jumlah data)
    describe('searchMovies dengan parameter pagination invalid', () => {
